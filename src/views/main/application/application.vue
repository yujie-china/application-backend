  ...
  <div>
    ...
    <div class="gva-table-box">
      <el-table :data="tableData">
        ...
        <el-table-column align="center" label="备注" min-width="120" prop="text" />
        <el-table-column align="center" fixed="right" label="操作" width="250">
          <el-button icon="document" type="primary" link @click="dialogFormVisible=true">详情</el-button>
